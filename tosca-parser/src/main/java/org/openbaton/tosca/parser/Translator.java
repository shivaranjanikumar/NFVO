...
import org.openbaton.tosca.catalogue.NodeTemplate;
import org.openbaton.tosca.catalogue.PropertiesVdu;

/**
 * Created by dbo on 02/12/15.
 */
public class Translator {

    public VirtualDeploymentUnit returnVDU(String name, NodeTemplate nodeTemplate){
