...
public class VDUProperties {
    ...
    private String vim_instance_name;
    ...
    public VDUProperties(Object vduProp){
        ...
        if(vduPropMap.containsKey("vim_instance_name")){
            vim_instance_name = (String) vduPropMap.get("vim_instance_name");
        }
    }
    ...
    public String getVim_instance_name() {
        return vim_instance_name;
    }

    public void setVim_instance_name(String vim_instance_name) {
    ...
    public String toString(){
        return "VDU Properties: " + "\n" +
                ...
                "vim instance name: " + vim_instance_name + "\n" ;
    }
}
